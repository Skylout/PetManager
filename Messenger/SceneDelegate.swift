        ...
        if let user = Auth.auth().currentUser {
            FirestoreService.shared.getUserData(user: user) { (result) in
                ...
                case .success(let muser):
                    let vc = storyboard.instantiateViewController(identifier: "NavigationController") as! UINavigationController
                    let chatVC = vc.topViewController as! ChatsViewController
                    chatVC.currentUser = muser
            ...
            window?.rootViewController = storyboard.instantiateViewController(identifier: "AuthController")
        }
    }
